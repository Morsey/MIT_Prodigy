...
# https://github.com/jmcclin2/updebouncein/blob/main/debounced_input.py

class DebouncedInput:
    """Micropython Debounced GPIO Input Class"""
    def __init__(self, pin_num, callback, pin_pull=None, pin_logic_pressed=True, debounce_ms=100, button_id=-1):
    ...
    def __ButtonDebounceTimerExpired(self, timer):
        ...
        if ((self.expected_value == True) and (current_value == True)):
            ...
            self.callback(self.pin_num, True, ms_since_last_press, self.button_id)
            ...
            self.callback(self.pin_num, False, ms_duration_of_press, self.button_id)
        #else:
