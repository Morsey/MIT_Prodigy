.pwa-toast[data-v-da2fdc7e]{position:fixed;right:0;bottom:0;margin:16px;padding:12px;border:1px solid #8885;background-color:rgb(var(--v-theme-background));border-radius:4px;z-index:1;text-align:left;box-shadow:3px 4px 5px #8885;display:grid}.pwa-toast .message[data-v-da2fdc7e]{margin-bottom:8px}.pwa-toast .buttons[data-v-da2fdc7e]{display:flex}.pwa-toast button[data-v-da2fdc7e]{border:1px solid #8885;outline:none;margin-right:5px;border-radius:2px;padding:3px 10px}.pwa-toast button.reload[data-v-da2fdc7e]{display:block}.nrdb-debug-view{margin:12px;max-width:1200px}.nrdb-debug-view h1{display:flex;flex-direction:row;align-items:center;justify-content:space-between}.nrdb-debug-description{font-size:.85rem;padding:16px}.debug-filters{display:flex;flex-direction:row;align-items:center;justify-content:flex-start;margin:16px}.debug-filters label{margin-right:1rem}.debug-filters-chips{display:flex;gap:8px;align-items:center}.nested-table,.nested-table .v-table{background-color:#eee}.nrdb-ui-notification{padding-top:64px}.nrdb-ui-notification .v-snackbar__wrapper{background-color:rgb(var(--v-theme-group-background));color:rgb(var(--v-theme-on-group-background));border-left:6px solid var(--nrdb-ui-notification-color)}.nrdb-ui-notification .v-snackbar__content{padding:8px 12px}.nrdb-ui-notification-countdown{position:absolute;width:calc(100% + 6px);top:0;left:0;margin-left:-6px;border-top-left-radius:4px}.nrdb-ui-notification h1,.nrdb-ui-notification h2,.nrdb-ui-notification h3,.nrdb-ui-notification h4{margin:.5rem 0}[data-v-5d0a4a8e] .v-field__input{--v-field-input-min-height: calc(var(--widget-row-height) - 4px)}[data-v-5d0a4a8e] .v-field--variant-outlined{--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}.nrdb-layout-group--grid[data-v-5d0a4a8e]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;gap:var(--widget-gap)}.nrdb-layout--flex[data-v-5d0a4a8e]{--layout-card-width: 320px;--layout-gap: 12px;--layout-columns: 100}.nrdb-layout--flex[data-v-5d0a4a8e]{display:flex;flex-wrap:wrap;padding:var(--page-padding);gap:var(--group-gap)}.nrdb-layout--flex>div[data-v-5d0a4a8e]{width:var(--layout-card-width);max-width:100%}.v-card[data-v-5d0a4a8e]{width:100%}@media only screen and (max-width: 576px){.nrdb-layout--flex[data-v-5d0a4a8e]{--layout-columns: 3}}[data-v-6dc0994f] .v-field__input{--v-field-input-min-height: calc(var(--widget-row-height) - 4px)}[data-v-6dc0994f] .v-field--variant-outlined{--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}.nrdb-layout-group--grid[data-v-6dc0994f]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;gap:var(--widget-gap)}.nrdb-layout--grid[data-v-6dc0994f]{--layout-card-width: 320px;--layout-gap: 12px;--widget-row-height: 48px}.nrdb-layout--grid[data-v-6dc0994f]{--layout-columns: 12;display:grid;grid-template-columns:repeat(var(--layout-columns),1fr);flex-wrap:wrap;padding:var(--page-padding);gap:var(--group-gap)}.nrdb-layout--grid>div[data-v-6dc0994f]{width:100%}.v-card[data-v-6dc0994f]{width:100%}@media only screen and (max-width: 1024px){.nrdb-layout--grid[data-v-6dc0994f]{--layout-columns: 9}}@media only screen and (max-width: 768px){.nrdb-layout--grid[data-v-6dc0994f]{--layout-columns: 6}}@media only screen and (max-width: 576px){.nrdb-layout--grid[data-v-6dc0994f]{--layout-columns: 3}}[data-v-47f6e7cd] .v-field__input{--v-field-input-min-height: calc(var(--widget-row-height) - 4px)}[data-v-47f6e7cd] .v-field--variant-outlined{--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}.nrdb-layout-group--grid[data-v-47f6e7cd]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;gap:var(--widget-gap)}.nrdb-layout--notebook[data-v-47f6e7cd]{--layout-card-width: 1024px;--layout-gap: 12px}.nrdb-layout--notebook[data-v-47f6e7cd]{margin:auto;width:100%;max-width:var(--layout-card-width);min-height:100%;flex-wrap:wrap;padding:var(--page-padding);--layout-columns: 12}.nrdb-layout--notebook>div[data-v-47f6e7cd]{width:100%;margin-bottom:var(--group-gap)}.v-card[data-v-47f6e7cd]{width:100%}@media only screen and (max-width: 1024px){.nrdb-layout--notebook[data-v-47f6e7cd]{--layout-columns: 9}}@media only screen and (max-width: 768px){.nrdb-layout--notebook[data-v-47f6e7cd]{--layout-columns: 6}}@media only screen and (max-width: 576px){.nrdb-layout--notebook[data-v-47f6e7cd]{--layout-columns: 3}}.nrdb-ui-button--icon .v-btn__append{margin-left:0;margin-inline:initial}.nrdb-ui-button--icon .v-btn__prepend{margin-right:0;margin-inline:initial}.nrdb-ui-button .v-btn .v-icon{--v-icon-size-multiplier: 1}.nrdb-ui-button .nrdb-ui-button--icon .v-icon{--v-icon-size-multiplier: 1.1}.nrdb-ui-button-group-wrapper{display:flex;flex-direction:row;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px}.nrdb-ui-button-group-wrapper .v-chip__content{white-space:normal}.nrdb-ui-button-group-wrapper .v-btn-group{width:max-content;border-width:thin;border-color:rgba(var(--v-border-color),var(--v-border-opacity))}.nrdb-ui-button-group-wrapper .v-btn--variant-elevated{color:rgb(var(--v-theme-on-group-background));background-color:rgb(var(--v-theme-group-background))}.nrdb-ui-button-group-wrapper .v-btn--variant-elevated{--v-activated-opacity: 0}.nrdb-ui-button-group-wrapper .icon-only .v-btn__prepend{margin-inline:0}.nrdb-ui-button-group-wrapper .v-btn.v-btn--disabled .v-btn__overlay{opacity:.1}.nrdb-ui-button-group-wrapper .v-btn-group .v-btn--disabled .v-btn__content{color:rgb(var(--v-theme-on-group-background),var(--v-disabled-opacity))}.nrdb-ui-chart-placeholder[data-v-59d0d5a1]{position:absolute;display:flex;justify-content:center;align-items:center;top:0;width:100%;height:100%;color:rgba(var(--v-theme-on-group-background),var(--v-disabled-opacity));--pie-slice-1: rgba(var(--v-theme-on-group-background), .05);--pie-slice-2: rgba(var(--v-theme-on-group-background), .1);background:radial-gradient(circle closest-side,rgb(var(--v-theme-group-background)) 50%,transparent 0),radial-gradient(circle closest-side,transparent 66%,rgb(var(--v-theme-group-background)) 0),conic-gradient(var(--pie-slice-1) 0,var(--pie-slice-1) 38%,var(--pie-slice-2) 0,var(--pie-slice-2) 61%)}.nrdb-ui-file-input{display:flex;gap:12px}.nrdb-ui-file-input .v-btn{max-height:var(--widget-row-height)}.nrdb-ui-file-input--progress{width:100%;display:flex;align-items:center}.nrdb-ui-file-input--uploaded{flex-grow:1;display:flex;align-items:center;justify-content:flex-start;gap:6px;height:var(--widget-row-height)}.nrdb-ui-gauge svg{flex-grow:1;max-width:100%;position:relative}.nrdb-ui-gauge-title{display:block;text-align:center;font-weight:700;font-size:1rem;padding-bottom:4px}.nrdb-ui-gauge-value{position:absolute;width:100%;height:100%;display:flex;align-content:center;justify-content:center;flex-direction:column;text-align:center;flex-wrap:wrap;padding-top:12px}.nrdb-ui-gauge-value span{font-weight:700}.nrdb-ui-gauge-value label{display:flex;align-items:center;justify-content:center}.nrdb-ui-gauge #backdrop path{fill:rgb(var(--v-theme-background))}.nrdb-ui-gauge #sections path{stroke:rgb(var(--v-theme-group-background));stroke-width:2px}.nrdb-ui-gauge #limits{opacity:.5;fill:rgb(var(--v-theme-on-group-background))}.nrdb-ui-gauge #needle-container{pointer-events:none}.nrdb-ui-gauge #needle-mask{opacity:0}.nrdb-ui-gauge #needle circle,.nrdb-ui-gauge #needle polygon{fill:rgb(var(--v-theme-on-group-background))}.nrdb-ui-gauge-value span{font-size:2rem;line-height:2.25rem}.nrdb-ui-gauge-value label{font-size:.75rem;line-height:.825rem;gap:4px}.nrdb-ui-gauge-icon-only i{font-size:1.75em}.nrdb-ui-gauge-size-xs .nrdb-ui-gauge-value span{font-size:1.5rem;line-height:1.75rem}.nrdb-ui-gauge-size-sm .nrdb-ui-gauge-value span{font-size:2rem;line-height:2.25rem}.nrdb-ui-gauge-size-md .nrdb-ui-gauge-value span{font-size:2.5rem;line-height:3rem}.nrdb-ui-gauge-size-md .nrdb-ui-gauge-value label{font-size:1rem;line-height:1.25rem}.nrdb-ui-gauge-size-lg .nrdb-ui-gauge-value span{font-size:3rem;line-height:3.25rem}.nrdb-ui-gauge-tile[data-v-f2a59060]{display:flex;justify-content:center;align-items:center;font-size:2.5rem;font-weight:700;transition:.15s background-color;border:1px solid rgb(var(--v-theme-group-outline))}.nrdb-ui-gauge{position:relative}/*!
  Theme: Default
